...
export interface BummyCoreInterface extends utils.Interface {
  functions: {
    ...
    "newContractAddress()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "newContractAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface BummyCore extends BaseContract {
  ...
  functions: {
    ...
    newContractAddress(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    newContractAddress(overrides?: CallOverrides): Promise<BigNumber>;
